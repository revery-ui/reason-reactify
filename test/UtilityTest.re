...
test("Utility", () => {
  ...
  test(
    "Constructors with different parameters should still have equal constructors",
    () =>
  ...
  test(
    "Constructors with same variant but different parameters should be equal",
    () =>
